...
for i=1:d
 ...
 s11=zeros(d);s12=zeros(d);s1=zeros(d);s21=zeros(d);s22=zeros(d);s2=zeros(d);
   ...
   E22=(1/n).*s22;
                              ...
                              %The MLE Estimates
for i=1:n
   p11(1,i)=transpose(t1(:,i)-u11)*inv(E11)*(t1(:,i)-u11);
   p12(1,i)=transpose(t1(:,i)-u12)*inv(E12)*(t1(:,i)-u12);
   p21(1,i)=transpose(t2(:,i)-u11)*inv(E21)*(t2(:,i)-u11);
   p22(1,i)=transpose(t2(:,i)-u12)*inv(E22)*(t2(:,i)-u12);
