...
for i=1:d
   ...
   for j=1:n
    ...
    u22(i,1)=sum22/n;
                               ...
                               %The MLE Estimates
for i=1:n
   p11(1,i)=-0.5*transpose(t1(:,i)-u11)*inv(E)*(t1(:,i)-u11);
   p12(1,i)=-0.5*transpose(t1(:,i)-u12)*inv(E)*(t1(:,i)-u12);
   
   p21(1,i)=-0.5*transpose(t2(:,i)-u21)*inv(E)*(t2(:,i)-u21);
   p22(1,i)=-0.5*transpose(t2(:,i)-u22)*inv(E)*(t2(:,i)-u22);
